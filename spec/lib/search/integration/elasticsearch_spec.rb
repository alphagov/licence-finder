...
RSpec.describe Search::Client::Elasticsearch do
  before(:each) do
    ...
    FactoryGirl.create(:sector, public_id: 123, correlation_id: 987, name: "Fooey Sector", layer: 3)
    ...
    FactoryGirl.create(:sector, public_id: 456, correlation_id: 984, name: "Something else", layer: 3)
    FactoryGirl.create(:activity, public_id: 7123, correlation_id: 983, name: "Fooey activity", sectors: [s2])
    FactoryGirl.create(:activity, public_id: 7124, correlation_id: 982, name: "Unrelated terms", sectors: [s3])
